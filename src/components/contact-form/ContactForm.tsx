  ...
  return (
    <form className="flex flex-col space-y-4">
      ...
      <textarea
        ...
        className="rounded-md border border-gray-300 p-2"
      />
      <div className="flex flex-col accent-lime-400">
        <label>
          <input type="checkbox" className="mr-2" />I agree to the terms and
          conditions
        </label>
        <label>
          <input type="checkbox" className="mr-2" />I want to receive marketing
          information
        </label>
        <label>
          <input type="checkbox" className="mr-2" />I want to receive newsletter
        </label>
      </div>
      ...
      <Button className="bg-lime-400 hover:bg-lime-600">Submit</Button>
    </form>
  );
};
